...
<x-admin-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ __("User") }}/</span> {{ __("Publish New User") }}</h4>
          ...
          <div class="col-xl">
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">{{ __("Publish New User") }}</h5>
                <small class="text-muted float-end">{{ __("Publish New User") }}</small>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route("admin.users.store") }}" autocomplete="off">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="Confirmation">{{ __("Password Confirmation")  }}</label>
                        <div class="input-group input-group-merge">
                            <span id="Confirmation2" class="input-group-text"
                                ><i class="bx bx-user"></i
                            ></span>
                            <input
                                type="password"
                                ...
                                placeholder="type here the Password Confirmation"
                                aria-label="John Doe"
                                autofocus
                                aria-describedby="Confirmation2"
                            />
                        </div>
                    </div>
